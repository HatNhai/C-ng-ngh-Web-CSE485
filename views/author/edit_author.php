    ...
    <main class="container mt-5 mb-5">
        <div class="row">
            <div class="col-sm">
                ...
                <form action="index.php?controller=author&action=saveEditAuthor" method="post">
                    <div class="input-group mt-3 mb-3">
                        <span class="input-group-text" id="lblCatId">Mã tác giả</span>
                        <input type="text" class="form-control" name="txtCatId" readonly value="<?php echo htmlspecialchars($author->getMaTacgia()); ?>"> <!-- Hiển thị ID -->
                    </div>

                    <div class="input-group mt-3 mb-3">
                        <span class="input-group-text" id="lblCatName">Tên tác giả</span>
                        <input type="text" class="form-control" name="txtCatName" value="<?php echo htmlspecialchars($author->getTenTgia()); ?>" required> <!-- Hiển thị tên tác giả -->
                    </div>
