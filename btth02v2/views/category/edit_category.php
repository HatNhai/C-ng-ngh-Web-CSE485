        ...
        <div class="row">
            <div class="col-sm">
                ...
                <div class="input-group mt-3 mb-3">
                        ...
                        <input type="text" class="form-control" name="txtCatId" value="<?php echo htmlspecialchars($category->getId());?>">
                    </div>

                    <div class="input-group mt-3 mb-3">
                        <span class="input-group-text" id="lblCatName">Tên thể loại</span>
                        <input type="text" class="form-control" name="txtCatName" value = "<?php echo htmlspecialchars($category->getName());?>">
                    </div>
