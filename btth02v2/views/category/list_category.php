...
<body>
    ...
    <main class="container mt-5 mb-5">
        ...
        <div class="row">
            <div class="col-sm">
                <a href="index.php?controller=category&action=viewAddCategory" class="btn btn-success">Thêm mới</a>
                <table class="table">
                    <thead>
                        <tr>
                            <th scope="col">#</th>
                    ...
                    <tbody>
                        ...
                        foreach ($categories as $category) {
                            ...
                            echo "<td><a href='index.php?controller=category&action=viewEditCategory&id=" . $category->getId() . "'><i class='fa-solid fa-pen-to-square'></i></a></td>";
                            echo "<td><a href='index.php?controller=category&action=delete&id=" . $category->getId() . "'><i class='fa-solid fa-trash'></i></a></td>";
                            echo "</tr>";
                        }
