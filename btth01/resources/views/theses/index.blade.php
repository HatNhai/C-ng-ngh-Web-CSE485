		...
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					...
					<div class="col-sm-6">
						<a href="{{ route('theses.create') }}" class="btn btn-success">Thêm mới </a>
					</div>
				</div>
			</div>
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
					...
					<td>{{ $thesis->id }}</td>
						...
						<td>
							<a href="{{ route('theses.edit', $thesis->id) }}" class="text-blue"><i class='fa-solid fa-pen-to-square'></i></a>
						</td>
						<td>
							
							<form action="{{ route('theses.destroy', $thesis->id) }}" method="POST" style="display:inline; " onsubmit="return confirm('Bạn có chắc chắn muốn xóa đồ án này không?');">
								@csrf
								@method('DELETE')
